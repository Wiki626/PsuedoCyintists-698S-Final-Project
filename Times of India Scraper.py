...
# Function to grab extra pages worth of articles
def grab_extra_pages(base_url, location, number_of_pages, class_type, dictionary):
    ...
    while x <= number_of_pages:
        ...
        x += 1
'''
Function for filtering the values of dictionaries by keywords and return keys to a list (only if the key has not
...
# Function for pulling the body text from the Time of India articles identified above
...
times_article_text = ''
times_article_text = article_lookup(top_news_links, base_url, '_1_Akb clearfix', times_article_text)
times_article_text = article_lookup(latest_stories_links, base_url, '_1_Akb clearfix', times_article_text)
