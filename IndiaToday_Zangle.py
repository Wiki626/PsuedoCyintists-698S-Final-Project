# -*- coding: utf-8 -*-
"""
Created on Sat Mar 21 20:21:51 2020
...
# Set site to search and keywords
...
# Cleans the dictionary of 'NoneType' entries
...
# Definition for filtering the values of dictionaries by keywords and return keys
# to a list (only if the key has not already been added to that list)
...
# Pulling the html location keys out of the dictionaries created above
# into a pair of lists
dict_search(it_stories, keywords, it_stories_links)
print(f'{len(it_stories_links)} results were found in India Today World News Stories.')
...
# Pulling the article and saving their text to a string
it_article_text = ''
